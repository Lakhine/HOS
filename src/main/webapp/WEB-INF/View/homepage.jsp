          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link" href="homepage" id="home">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="about.html" id="about"> About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="departments.html" id="dep">Departments</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="doctors.html" id="doc">Doctors</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="appointment.html" id="get">Get Appointment</a>
              </li>
          ...
          <div class="box">
            <div class="img-box">
              ...
              <!-- <div class="image-text">
                <h1><b><i>Dr.Seo Wojin</i></b></h1>
                <p>Age - 45 <br><br><b>specialization</b><br>Orthopedic Surgery <br><br><a href="">Get Appointment</a></p>    
              </div> -->
            </div>
            <div class="detail-box">
              <div class="social_box">
          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-md-11 col-lg-10 mx-auto">
                <div class="box">
                  <div class="img-box">
                    <img src="${pageContext.request.contextPath}/resources/images/client.jpg" alt="" />
                  </div>
                  <div class="detail-box">
                    <div class="name">
                      <h6>
